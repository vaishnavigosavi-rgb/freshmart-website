...
const Products = () => {
    ...
    const renderCards = filteredItems.slice(0, 4).map(product=>{
        return(
        ...
        <section>
            <div className='max-w-[1400px] mx-auto px-10 py-20'>
                  ...
                  <div className='flex gap-5 justify-center mt-10'>
                    {categories.map(category=>{
                        return(
                            ...
                            ${activeTab === category ? 'bg-gradient-to-b from-green-400 to-green-500 text-white' : 'bg-zinc-100'}`}
                ...
                <div className='mt-15 mx-auto w-fit'>
                   <Link to="/allproducts" className='bg-gradient-to-b from-green-400 to-green-500 text-white px-8 py-3 
